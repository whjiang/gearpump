...
class OpTranslator extends java.io.Serializable {
  def translate(ops: OpChain)(implicit system: ActorSystem): Processor = {
        ...
        op match {
          ...
          case merge: MergeOp =>
            Processor[TransformTask[Object, Object]](1,
              ...
              taskConf = userConfig)
          case ProcessorOp(processor, parallism, desc) =>
            new Processor {
              def taskClass = processor
              def parallelism = parallism
              def description = desc + "." + func.description
              def taskConf = null
            }
        }
      case op: SlaveOp =>
